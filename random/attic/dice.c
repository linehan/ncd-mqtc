...
/*struct alias_worklist { double prob; struct list_t node; };*/
...
/*{*/
	...
	/*for (i=0; ((!(list_empty(&Sm))) && (!(list_empty(&Lg)))); i++) {*/
		...
		/*tmp_s = (struct alias_worklist *)list_head(&Sm);*/
			/*list_remove_from(&Sm, tmp_s);*/

		/*tmp_l = (struct alias_worklist *)list_head(&Lg);*/
			/*list_remove_from(&Lg, tmp_l);*/
